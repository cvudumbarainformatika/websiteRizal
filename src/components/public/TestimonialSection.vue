<template>
  <section id="testimoni" class="px-5 flex flex-col max-w-4xl mx-auto w-full relative z-30 mb-10">
    ...
    <div class="mb-6 px-1 flex items-end justify-between">
      <div>
        <h2 class="text-gray-900 font-black leading-[1.25] text-[26px] tracking-tight mb-2">
          Testimoni &<br/>Ulasan <span class="text-[#FFC107]">Pelanggan</span>
        </h2>
        <p class="font-body-md text-gray-500 text-[13px] leading-[1.6] max-w-[280px]">
          Apa kata mereka yang sudah menggunakan layanan perjalanan kami.
        </p>
      </div>
      <button @click="router.push('/testimoni')" class="text-[#FFC107] font-bold text-[13px] flex items-center gap-1 hover:opacity-80 transition-opacity whitespace-nowrap pb-1">
        Lihat Semua
